...
public class GetAllVariacoesProdutosEndpoint : IEndpoint
{
    public static void Map(IEndpointRouteBuilder app)
    => app.MapGet("/", HandleAsync)
        .WithName("VariacaoProdutos : GetAll")
        .WithSummary("Obtém todas as variações de produtos")
        .WithDescription("Obtém todas as variações de produtos")
        .WithOrder(2)
